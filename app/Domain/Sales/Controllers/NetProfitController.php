    ...
    public function exportCurrentMonthData()
{
    ...
    $startDate = Carbon::parse('2025-04-01')->format('Y-m-d');
    $endDate = Carbon::parse('2025-04-30')->format('Y-m-d');
    
    // Use the same query structure but with specific date range
    $baseQuery = DB::table('net_profits as np')
        ...
        ->where('np.tenant_id', '=', $currentTenantId)
        ->whereBetween('np.date', [$startDate, $endDate]) // Use specific date range
        ->orderBy('np.date');
    ...
    return response()->json([
        'success' => true, 
        'message' => 'April 2025 data exported successfully to Google Sheets',
        'date_range' => 'April 1-30, 2025',
