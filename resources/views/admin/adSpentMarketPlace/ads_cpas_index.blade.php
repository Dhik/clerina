...
@section('content')
    <div class="card">
        ...
        <div class="card-body">
            <div class="tab-content" id="monitorTabsContent">
                ...
                @include('admin.adSpentSocialMedia.tabs.shopee2_tab')
                @include('admin.adSpentSocialMedia.tabs.shopee3_tab')
    ...
    @include('admin.adSpentSocialMedia.modals.shopee2_modal')
...
@section('js')
    ...
    @include('admin.adSpentSocialMedia.js.shopee2-ads')
    @include('admin.adSpentSocialMedia.js.shopee3-ads')
