    ...
    <div class="row">
        <div class="col-12">
            <div class="card">
                ...
                <form action="{{ route('kPIEmployee.update', $kPIEmployee->id) }}" method="POST">
                    @csrf
                    @method('PUT')
                    <div class="card-body">
                        <div class="row">
                            <div class="col-md-6">
                                <div class="form-group">
                                    ...
                                    <input type="text" class="form-control @error('kpi') is-invalid @enderror" 
                                           id="kpi" name="kpi" value="{{ old('kpi', $kPIEmployee->kpi) }}" required>
                                    @error('kpi')
                                    ...
                                    <select class="form-control select2 @error('employee_id') is-invalid @enderror" 
                                        ...
                                        @foreach($employees as $employee)
                                            <option value="{{ $employee->employee_id }}" 
                                                {{ $employee->employee_id == $kPIEmployee->employee_id ? 'selected' : '' }}>
                                    ...
                                    <select class="form-control @error('department') is-invalid @enderror" 
                                        ...
                                        @foreach($departments as $department)
                                            <option value="{{ $department }}" 
                                                {{ old('department', $kPIEmployee->department) == $department ? 'selected' : '' }}>
                                                {{ $department }}
                                            </option>
                                        @endforeach
                                    </select>
                                    ...
                                    <select class="form-control @error('position') is-invalid @enderror" 
                                        ...
                                        @foreach($positions as $position)
                                            <option value="{{ $position }}" 
                                                {{ old('position', $kPIEmployee->position) == $position ? 'selected' : '' }}>
                                                {{ $position }}
                                            </option>
                                        @endforeach
                                    </select>
                                ...
                                <div class="form-group">
                                    ...
                                    <select class="form-control @error('method_calculation') is-invalid @enderror" 
                                        ...
                                        @foreach($methods as $method)
                                            <option value="{{ $method }}" 
                                                {{ old('method_calculation', $kPIEmployee->method_calculation) == $method ? 'selected' : '' }}>
                                                {{ ucfirst($method) }}
                                            </option>
                                        @endforeach
                                    </select>
                                    ...
                                    <select class="form-control @error('perspective') is-invalid @enderror" 
                                        ...
                                        @foreach($perspectives as $perspective)
                                            <option value="{{ $perspective }}" 
                                                {{ old('perspective', $kPIEmployee->perspective) == $perspective ? 'selected' : '' }}>
                                                {{ $perspective }}
                                            </option>
                                        @endforeach
                                    </select>
                            ...
                            <div class="col-md-3">
                                <div class="form-group">
                                    ...
                                    <input type="text" class="form-control @error('data_source') is-invalid @enderror" 
                                           id="data_source" name="data_source" value="{{ old('data_source', $kPIEmployee->data_source) }}" required>
                                    @error('data_source')
                                        <span class="invalid-feedback">{{ $message }}</span>
                                    @enderror
                                </div>
                            ...
                            <div class="col-md-3">
                                <div class="form-group">
                                    ...
                                    <input type="number" step="0.01" class="form-control @error('target') is-invalid @enderror" 
                                           id="target" name="target" value="{{ old('target', $kPIEmployee->target) }}" required>
                                    @error('target')
                                        <span class="invalid-feedback">{{ $message }}</span>
                                    @enderror
                                </div>
                            ...
                            <div class="col-md-3">
                                <div class="form-group">
                                    ...
                                    <input type="number" step="0.01" class="form-control @error('actual') is-invalid @enderror" 
                                           id="actual" name="actual" value="{{ old('actual', $kPIEmployee->actual) }}">
                                    @error('actual')
                                        <span class="invalid-feedback">{{ $message }}</span>
                                    @enderror
                                </div>
                            ...
                            <div class="col-md-3">
                                <div class="form-group">
                                    ...
                                    <input type="number" step="0.01" max="100" class="form-control @error('bobot') is-invalid @enderror" 
                                           id="bobot" name="bobot" value="{{ old('bobot', $kPIEmployee->bobot) }}" required>
                                    @error('bobot')
                                        <span class="invalid-feedback">{{ $message }}</span>
                                    @enderror
                                </div>
